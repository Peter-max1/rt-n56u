...
#define DEF_WLAN_2G_SSID	 "EASY_FASTBOX_%s"
#define DEF_WLAN_5G_SSID	 "EASY_FASTBOX_5G_%s"
#define DEF_WLAN_2G_GSSID	 "EASY_FASTBOX_GUEST_%s"
#define DEF_WLAN_5G_GSSID	 "EASY_FASTBOX_GUEST_5G_%s"
